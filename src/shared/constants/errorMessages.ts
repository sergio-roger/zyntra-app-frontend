export const ERROR_MESSAGES: Record<string, string> = {
  ...
  'must be longer than or equal to 6 characters': 'Debe tener al menos 6 caracteres',
  'must be shorter than or equal to 120 characters': 'No puede superar los 120 caracteres',
  'must be shorter than or equal to 40 characters': 'No puede superar los 40 caracteres',

  // --- Auth ---
  'Credenciales incorrectas': 'Correo o contraseña incorrectos',
  'Invalid or expired reset token': 'El enlace de recuperación es inválido o ha expirado',

  // --- Usuarios / Settings ---
  'Email already registered': 'Este correo ya está registrado',
  'Email already registered for this business': 'Este correo ya está registrado en tu organización',
  ...
  'Error al procesar mensaje': 'No se pudo procesar el mensaje. Intenta de nuevo',
};

export const ERROR_CODE_MESSAGES: Record<string, string> = {
  E0001: 'Tu sesión ha expirado o no tienes autorización. Inicia sesión de nuevo',
  ...
  E5000: 'Error interno del servidor. Contacta a soporte si el problema persiste',
