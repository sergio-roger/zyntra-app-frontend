    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <CardWrapper hoverable={false} className="p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-bold text-base-content/90">
                  Etapas de ciclo de vida
                </h2>
                <p className="text-xs text-base-content/50">
                  Rastrea contactos a través de etapas clave.
                </p>
              </div>
            </div>
              ...
              {addingTo === 'active' ? (
                <div className="bg-base-100 rounded-xl p-3 border border-primary/30 shadow-lg">
                  ...
                  <div className="space-y-2">
                    <div>
                      <label className="text-[9px] font-bold text-base-content/40 ml-1">
                        Nombre
                      </label>
                      <input
                        autoFocus
        ...
        <div className="space-y-4">
          <CardWrapper
            hoverable={false}
            className="p-6 border-amber-500/10 bg-amber-500/5"
          >
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xl">😔</span>
              <div>
                ...
                <p className="text-xs text-amber-500/50">
                  Rastrea dónde van los contactos al salir del proceso.
                </p>
              </div>
            </div>
                ...
                <div className="bg-base-100 rounded-xl p-3 border border-amber-500/30 shadow-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                      ...
                      <button
                        onClick={confirmAddStage}
                        className="btn btn-warning btn-sm btn-xs px-5 shadow-lg shadow-warning/20 text-[10px]"
                      >
                        Añadir
                      </button>
                    </div>
