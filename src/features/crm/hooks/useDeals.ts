...
export const useUpdatePipeline = () => {
  ...
  return useMutation({
    mutationFn: async (vars: {
      id: string;
      input: Parameters<typeof pipelinesApi.update>[1];
    }) => {
...
export const useCreateStage = () => {
  ...
  return useMutation({
    mutationFn: async (vars: {
      pipelineId: string;
      input: Parameters<typeof pipelinesApi.createStage>[1];
    }) => {
...
export const useUpdateStage = () => {
  ...
  return useMutation({
    mutationFn: async (vars: {
      stageId: string;
      input: Parameters<typeof pipelinesApi.updateStage>[1];
    }) => {
...
export const useReorderStages = () => {
  ...
  return useMutation({
    mutationFn: async (vars: {
      ...
      const res = await pipelinesApi.reorderStages(vars.pipelineId, {
        stages: vars.stages,
      });
      return res.data;
    },
