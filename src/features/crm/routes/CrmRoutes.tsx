...
const SegmentsPage = lazy(() => import('@crm/pages/SegmentsPage').then(m => ({ default: m.SegmentsPage })));
...
export const crmRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'segments', element: <PermissionGuard menuKey="crm_segments"><ModuleGuard menuKey="crm_segments"><SuspenseLoader><SegmentsPage /></SuspenseLoader></ModuleGuard></PermissionGuard> }
    ]
  }
];
