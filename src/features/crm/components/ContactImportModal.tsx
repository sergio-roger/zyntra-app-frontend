...
const CRM_FIELDS = [
  ...
  { id: 'channelId', label: 'ID de Canal', required: false },
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Soportamos archivos .csv (separados por comas)
                  </p>
                </div>
                <input
                  type="file"
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <ul className="text-[11px] text-slate-500 space-y-1 list-disc ml-3">
                      <li>
                        Asegúrate de que la primera fila contenga los títulos de
                        las columnas.
                      </li>
                      <li>
                        El archivo debe estar codificado en UTF-8 para evitar
                        errores de caracteres.
                      </li>
                      <li>
                        El campo 'Nombre' es indispensable para crear el
                        contacto.
                      </li>
                    </ul>
                  </div>
            ...
            <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
              ...
              <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                {CRM_FIELDS.map((field) => (
                  <div
                    key={field.id}
                    className="flex items-center gap-4 bg-slate-950/30 p-3 rounded-2xl border border-white/5 hover:border-white/10 transition-colors"
                  >
                    <div className="flex-1">
                      ...
                      <p className="text-[10px] text-slate-500 uppercase tracking-tighter font-mono mt-0.5">
                        Campo CRM
                      </p>
                    </div>
          ...
          {step === 'importing' && (
            <div className="py-12 flex flex-col items-center justify-center gap-4 animate-in fade-in">
              <div className="relative">
                ...
                <Loader2
                  size={48}
                  className="text-indigo-500 animate-spin relative"
                />
              </div>
              <div className="text-center">
                <p className="text-sm font-bold text-white">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Estamos validando y guardando tus contactos.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="py-8 flex flex-col items-center justify-center gap-6 animate-in zoom-in duration-500">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Se han procesado correctamente todos tus contactos.
                </p>
              </div>
