            ...
            {step === "upload" && (
              <>
                ...
                >
                  ...
                  <div className="text-center">
                    <p className="text-sm font-medium text-slate-300">
                      ...
                      <span className="text-indigo-400">haz clic para elegir</span>
                    </p>
                ...
                <div className="rounded-xl border border-white/5 bg-slate-800/30 px-4 py-3 text-xs text-slate-400 space-y-1">
                  <p className="font-semibold text-slate-300">Columnas soportadas:</p>
                  <p>
                    <span className="text-indigo-300 font-mono">nombre</span> (requerido),{" "}
                    <span className="font-mono text-slate-400">ruc / identificación, web, empleados, descripción</span>
                  </p>
                </div>
              ...
              <>
                <div className="flex items-center gap-3 rounded-xl border border-indigo-500/20 bg-indigo-500/10 px-4 py-3 text-sm">
                  ...
                  <p className="text-indigo-300">
                    Se importarán{" "}
                    <span className="font-bold">{parsedRows.length} empresa{parsedRows.length !== 1 ? "s" : ""}</span>.
                  ...
                  <table className="w-full text-xs">
                    <thead className="border-b border-white/10 bg-slate-900/80 text-slate-400">
                      <tr>
                        ...
                        <th className="px-3 py-2 text-left font-semibold">Web</th>
                      </tr>
                    </thead>
                    <tbody>
                      {parsedRows.slice(0, 50).map((r, i) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2 text-slate-400">{r.identification ?? "—"}</td>
              ...
              <div className="flex flex-col items-center justify-center gap-4 py-10">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-sm text-slate-400">
                    Se importaron <span className="font-bold text-emerald-400">{importedCount}</span> empresas correctamente.
                  </p>
                </div>
              </div>
            )}
