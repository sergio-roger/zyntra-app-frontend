...
export const CompanyCustomFieldsSidebar: React.FC<
  CompanyCustomFieldsSidebarProps
            ...
            {activeFields.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 px-4 text-center border-2 border-dashed border-white/10 rounded-2xl">
                ...
                <p className="text-xs text-slate-400 max-w-xs mb-6">
                  Aún no has configurado campos personalizados para empresas. Ve
                  a Campos para crearlos.
                </p>
                <button
                  onClick={() => {
                    navigate('/crm/fields');
