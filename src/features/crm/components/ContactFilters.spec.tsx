...
vi.mock('@shared/api/axios', () => ({
  default: {
    get: vi.fn().mockResolvedValue({
      data: [
        { id: 's1', name: 'Nuevo lead', icon: '🟢', color: '#22c55e', type: 'active' },
        { id: 's2', name: 'Perdido', icon: '🔴', color: '#ef4444', type: 'lost' },
      ],
    }),
  },
}));
...
describe('ContactFilters', () => {
  ...
  it('does NOT render the owner selector when showOwnerFilter is false', () => {
    ...
    expect(screen.queryByText('Todos los colaboradores')).not.toBeInTheDocument();
  });
