  ...
  return (
    <div className="flex flex-col gap-6 p-1">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white tracking-tight">Etiquetas</h2>
          <p className="text-sm text-slate-400">Organiza y segmenta tus contactos eficazmente.</p>
        </div>
          ...
          {filteredTags?.length === 0 && (
            <div className="col-span-full">
              <EmptyState 
                ...
                description={search ? `No se encontraron etiquetas que coincidan con "${search}"` : "Aún no has creado etiquetas para segmentar a tus contactos."}
