...
import { ContactPanel } from '@features/inbox/components/ContactPanel';
import { useChannels } from '@features/inbox/hooks/useChannels';
...
import { useConversationSocket } from '@features/inbox/hooks/useConversationSocket';
import {
  useInboxSoundSetting,
  useSetInboxSoundSetting,
} from '@features/inbox/hooks/useInboxSoundSetting';
import { useSendAgentMessage } from '@features/inbox/hooks/useSendAgentMessage';
import { useMarkConversationAsRead } from '@features/inbox/hooks/useMarkConversationAsRead';
import { useAssignConversation } from '@features/inbox/hooks/useAssignConversation';
import { useUpdateConversationStatus } from '@features/inbox/hooks/useUpdateConversationStatus';
import {
  getAttendedByInfo,
  getStatusDot,
  STATUS_OPTIONS,
  VIEW_TABS,
  formatDate,
} from '@features/inbox/constants/inbox.constants';
