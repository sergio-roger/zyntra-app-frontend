...
export const UserMenu: React.FC = () => {
  ...
  return (
    <div
      className="mt-auto flex flex-col items-center gap-2 pt-3"
      ref={containerRef}
    >
      {/* Avatar Dropdown */}
      <div
      ...
      >
        ...
        {isUserMenuOpen && (
          <ul
            tabIndex={0}
            className="dropdown-content menu p-2 shadow-2xl bg-base-200 border border-base-300 rounded-box w-56 z-[200]"
          >
            <div className="px-4 py-3 border-b border-base-300 mb-2">
              <p className="text-xs font-bold text-base-content/90 truncate">
                {user?.name}
              </p>
