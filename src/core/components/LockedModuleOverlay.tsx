...
const PLAN_NAMES: Record<string, string> = {
  ...
  agents_store: 'Impulse Pro',
  agents_projects: 'Impulse Pro',
  agents_team: 'Impulse Pro',
  ...
  drive: 'Core Digital',
  automations: 'Impulse Pro',
  automations_agents: 'Impulse Pro',
  automations_agents_identity: 'Impulse Pro',
  automations_agents_tools: 'Impulse Pro',
  automations_agents_knowledge: 'Impulse Pro',
  automations_agents_voice: 'Impulse Pro',
  automations_agents_memory: 'Impulse Pro',
